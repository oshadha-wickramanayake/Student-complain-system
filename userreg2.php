	...
	if(mysqli_query($conn,$query1))
	{
		...
		if($check==0)
		{
			...
			$chk=mysqli_query($conn,$query);
				...
				if($chk)
				{
					$msg1 ="<h5 style='padding:10px'>Sign Up Successfully!! Now you can <a href='userlogin1.html'>Login here</a>
		...
		$newname=  generateRandomString();
			...
			$newname5=$uname.generateRandomString();
				...
				$msg1 ="<h4>User name ($uname) already exist .Please <a href='userreg1.html'> try again </a>with different.</h4><br />
...
<body>
		...
		<div class="nav-item item1" style="margin-left:5%">
				<h2 onclick='window.new("index.html");' style="cursor:pointer">NIBM Complaint System</h2>
		</div>
